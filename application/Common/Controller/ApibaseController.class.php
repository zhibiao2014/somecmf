...
class ApibaseController extends Controller {
	...
	public function _initialize() {
	    ...
	    if($option){
	        $this->site_token=json_decode($option['option_value'],true)['site_token'];
	    }
	     
	    $token=$_REQUEST['token'];
// 	    var_dump($this->site_token);
	    if($token!=$this->site_token){
	        echo json_encode(array('code' => '00000','message' => "hacker attack!",'data' => NULL));die();
	    }
	}
