/*
 ...
 Source Database       : ypyh

 Target Server Type    : MySQL
 Target Server Version : 50505
 File Encoding         : utf-8

 Date: 08/20/2017 22:29:02 PM
*/
...
-- ----------------------------
--  Table structure for `ypyh_ad`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_ad`;
CREATE TABLE `ypyh_ad` (
...
-- ----------------------------
--  Table structure for `ypyh_asset`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_asset`;
CREATE TABLE `ypyh_asset` (
...
-- ----------------------------
--  Table structure for `ypyh_auth_access`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_auth_access`;
CREATE TABLE `ypyh_auth_access` (
...
-- ----------------------------
--  Table structure for `ypyh_auth_rule`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_auth_rule`;
CREATE TABLE `ypyh_auth_rule` (
...
-- ----------------------------
--  Table structure for `ypyh_common_action_log`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_common_action_log`;
CREATE TABLE `ypyh_common_action_log` (
...
-- ----------------------------
--  Table structure for `ypyh_guestbook`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_guestbook`;
CREATE TABLE `ypyh_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `ypyh_links`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_links`;
CREATE TABLE `ypyh_links` (
...
-- ----------------------------
--  Records of `ypyh_links`
-- ----------------------------
BEGIN;
INSERT INTO `ypyh_links` VALUES ('1', 'http://www.thinkcmf.com', 'ThinkCMF', '', '_blank', '', '1', '0', '', '0');
COMMIT;

-- ----------------------------
--  Table structure for `ypyh_menu`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_menu`;
CREATE TABLE `ypyh_menu` (
...
-- ----------------------------
BEGIN;
INSERT INTO `ypyh_nav` VALUES ('1', '1', '0', '首页', '', 'home', '', '1', '0', '0-1'), ('2', '1', '0', '列表演示', '', 'a:2:{s:6:\"action\";s:17:\"Portal/List/index\";s:5:\"param\";a:1:{s:2:\"id\";s:1:\"1\";}}', '', '1', '0', '0-2'), ('3', '1', '0', '瀑布流', '', 'a:2:{s:6:\"action\";s:17:\"Portal/List/index\";s:5:\"param\";a:1:{s:2:\"id\";s:1:\"2\";}}', '', '1', '0', '0-3');
COMMIT;

-- ----------------------------
--  Table structure for `ypyh_nav_cat`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_nav_cat`;
CREATE TABLE `ypyh_nav_cat` (
...
-- ----------------------------
--  Records of `ypyh_nav_cat`
-- ----------------------------
BEGIN;
INSERT INTO `ypyh_nav_cat` VALUES ('1', '主导航', '1', '主导航');
COMMIT;

-- ----------------------------
--  Table structure for `ypyh_oauth_user`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_oauth_user`;
CREATE TABLE `ypyh_oauth_user` (
...
-- ----------------------------
--  Table structure for `ypyh_options`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_options`;
CREATE TABLE `ypyh_options` (
...
-- ----------------------------
--  Table structure for `ypyh_posts`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_posts`;
CREATE TABLE `ypyh_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `ypyh_role`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_role`;
CREATE TABLE `ypyh_role` (
...
-- ----------------------------
--  Records of `ypyh_role`
-- ----------------------------
BEGIN;
INSERT INTO `ypyh_role` VALUES ('1', '超级管理员', '0', '1', '拥有网站最高管理员权限！', '1329633709', '1329633709', '0');
COMMIT;

-- ----------------------------
--  Table structure for `ypyh_role_user`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_role_user`;
CREATE TABLE `ypyh_role_user` (
...
-- ----------------------------
--  Table structure for `ypyh_route`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_route`;
CREATE TABLE `ypyh_route` (
...
-- ----------------------------
--  Table structure for `ypyh_slide`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_slide`;
CREATE TABLE `ypyh_slide` (
...
-- ----------------------------
--  Table structure for `ypyh_slide_cat`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_slide_cat`;
CREATE TABLE `ypyh_slide_cat` (
...
-- ----------------------------
--  Table structure for `ypyh_term_relationships`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_term_relationships`;
CREATE TABLE `ypyh_term_relationships` (
...
-- ----------------------------
--  Table structure for `ypyh_terms`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_terms`;
CREATE TABLE `ypyh_terms` (
...
-- ----------------------------
--  Records of `ypyh_terms`
-- ----------------------------
BEGIN;
INSERT INTO `ypyh_terms` VALUES ('1', '列表演示', '', 'article', '', '0', '0', '0-1', '', '', '', 'list', 'article', '0', '1'), ('2', '瀑布流', '', 'article', '', '0', '0', '0-2', '', '', '', 'list_masonry', 'article', '0', '1');
COMMIT;

-- ----------------------------
--  Table structure for `ypyh_user_favorites`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_user_favorites`;
CREATE TABLE `ypyh_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Table structure for `ypyh_users`
-- ----------------------------
DROP TABLE IF EXISTS `ypyh_users`;
CREATE TABLE `ypyh_users` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `ypyh_users`
-- ----------------------------
BEGIN;
INSERT INTO `ypyh_users` VALUES ('1', 'admin', '###2bf283123b7c5d65ff87b1f8434a691d', 'admin', '276595510@qq.com', '', null, '0', '2000-01-01', null, '127.0.0.1', '2017-08-20 22:27:25', '2017-08-20 09:25:15', '', '1', '0', '1', '0', '');
COMMIT;
